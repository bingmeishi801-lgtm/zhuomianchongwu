"""GIF background removal with human segmentation model."""
...
def main():
    if len(sys.argv) < 3:
        print("Usage: python gif_human_seg.py <input.gif> <output_dir>")
        sys.exit(1)
    ...
    print("[2/4] Removing backgrounds with u2net_human_seg...")
